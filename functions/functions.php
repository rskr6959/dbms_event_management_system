...
$db = mysqli_connect("localhost","root","","events_db");
...
echo "<li><a href='venues.php?p_cat=$p_cat_id'> $p_cat_title </a></li>";
...
echo "<li><a href='venues.php?cat=$cat_id'>$cat_title</a></li>";
...
<a href='details.php?pro_id=$pro_id' class='btn btn-default'> View Details Of Events </a>
