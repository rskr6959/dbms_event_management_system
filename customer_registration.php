...
<body>
    ...
    <div class="col-md-6 offer"> <!-- col-md-6 offer start-->
        ...
        <a href="#">Bookings Total Price : 10$ ,  Available Events 2</a>
            ...
            <ul class="menu">
                ...
                <li>
                 ...
                 <li>
                    ...
                    <a href="bookings.php">Goto Cart</a>
    ...
    <div class="navbar navbar-default " id="navbar"> <!-- navbar navbar-default start-->
       <div class="container">
           ...
           <div class="navbar-collapse collapse" id="navigation"> <!-- navbar-collapse collapse start-->
               ...
               <a href="bookings.php" class="btn btn-info navbar-btn right">
                   <i class="fa fa-venuesping-cart">
               ...
               <div class="navbar-collapse collapse right">  <!-- navbar-collapse collapse-right start-->
                   ...
                   <button class="btn navbar-btn btn-info" type="button" data-toggle="collapse" data-target="#search">
