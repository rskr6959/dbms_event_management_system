...
<i class="fa fa-fw fa-envelope"></i>Event  
...
<i class="fa fa-fw fa-gear"></i>Venue  
...
<i class="fa fa-fw fa-power-off"></i>Log Out    
 ...
 <i class="fa fa-fw fa-caret-down"></i>
  ...
  <ul id="products" class="collapse">
    ...
    <li>
    <a href="index.php?insert_product">Insert Event</a>    
    </li>
     
       <li>
    <a href="index.php?view_products">View Event</a>    
    </li>
 ...
 <i class="fa fa-fw fa-pencil"></i>Venue  
 <i class="fa fa-fw fa-caret-down"></i>
  </a>
  ...
  <ul id="p_cat" class="collapse">
    ...
    <li>
    <a href="index.php?insert_p_cat">Insert Venue</a>    
    </li>
     
       <li>
    <a href="index.php?view_p_cats">View Venue</a>    
    </li>
