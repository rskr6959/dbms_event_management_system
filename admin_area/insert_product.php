...
<i class="fa fa-dashboard"> </i> Dashboard / Insert Event
...
<i class="fa fa-money fa-fw"></i> Insert Event
...
<label class="col-md-3 control-label" > Venue type </label>
...
<label class="col-md-3 control-label" > Event Image 1 </label>
...
<label class="col-md-3 control-label" > Event Image 2 </label>
...
<label class="col-md-3 control-label" > Event Image 3 </label>
...
<label class="col-md-3 control-label" > Audience Capacity  </label>
...
<label class="col-md-3 control-label" > Event price </label>
...
<label class="col-md-3 control-label" > Event Keywords </label>
